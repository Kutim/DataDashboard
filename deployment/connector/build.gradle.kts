...
//    implementation(libs.edc.data.plane.api) // 0.4.1
...
//    implementation(libs.edc.data.plane.selector.client)
    ...
    implementation(libs.edc.identity.hub.ext.api.did.mgmt.api)
//    implementation(libs.edc.identity.hub.ext.api.identityhub.api.authentication)
//    implementation(libs.edc.identity.hub.ext.api.identityhub.api.authorization)
    implementation(libs.edc.identity.hub.ext.api.identityhub.management.api.configuration)
    implementation(libs.edc.identity.hub.ext.api.keypair.mgmt.api)
    implementation(libs.edc.identity.hub.ext.api.participant.context.mgmt.api)
    implementation(libs.edc.identity.hub.ext.api.verifiable.credential.mgmt.api)
    implementation(libs.edc.identity.hub.ext.did.local.did.publisher)
